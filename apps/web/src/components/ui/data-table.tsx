...
export function TableHeader({
  ...
  return (
    <thead
      className={`bg-slate-50/90 dark:bg-slate-800/90 border-b border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider ${className}`}
      {...props}
    >
      {children}
    </thead>
