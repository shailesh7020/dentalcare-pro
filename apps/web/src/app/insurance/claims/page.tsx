            ...
            <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-xl overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
                <div className="flex items-center gap-2">
                  <h3 className="text-base font-bold text-slate-900">Create Dental Claim</h3>
              ...
              <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Pre-Auth UUID (Optional)</label>
                    <input
                      type="text"
                  ...
                  <div className="col-span-2 border-t border-slate-200 pt-3">
                    <h4 className="text-xs font-bold text-slate-800 mb-2">Procedure Line Item</h4>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Tooth #</label>
                    <input
                      type="text"
                      placeholder="e.g. 46"
                      value={toothNumber}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Procedure Fee / Cost (₹) *</label>
                    <input
                      type="number"
                      value={unitCost}
                      onChange={(e) => {
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Expected Payer Share (80%)</label>
                    <input
                      type="number"
                      value={coveredAmount}
